...
{
    public class AtuacaoMapper : EntityTypeConfiguration<AtuacaoDto>
    {
        public AtuacaoMapper()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("ST_ATUACAO", "dbo");

            // Propertys Relationship Database Table Columns
            this.Property(_ => _.ID).HasColumnName("ID_ATUACAO");
