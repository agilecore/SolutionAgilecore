...
namespace Gerador.Infrastructure
{
    ...
    public class Data
    {
        ...
        public String BuildModels(KeyValuePair<String, ModelConfig> TableSetting)
        {
            ...
            return CreateFileCommom(String.Concat(DataModel.ClassName, SufixoModels), @"Models\" + DataModel.ClassName);
        }
        ...
        public String BuildRespository()
        {
            ...
            TextClass.AppendLine("{");
            TextClass.AppendLine("    public class Repository<TEntity> : IDisposable, IRepository<TEntity> where TEntity : class");
            TextClass.AppendLine("    {");
